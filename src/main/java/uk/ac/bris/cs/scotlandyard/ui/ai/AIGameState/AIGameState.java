...
//            private LogEntry hideOrReveal(ScotlandYard.Ticket ticket, int destination) {
...
//
//            //Compute the state of MrX's move that should be added to the log
//            private ImmutableList<LogEntry> updateLog(LogEntry addToLog) {
//                return ImmutableList.<LogEntry>builder()
//                        .addAll(getMrXTravelLog())
//                        .add(addToLog)
//                        .build();
//            }
//
...
//                    LogEntry hideOrReveal1 = hideOrReveal(move.ticket, move.destination);
//                    log = updateLog(hideOrReveal1);
//
//                    //Take used ticket from the MrX and move them to the new destination
//                    mrX = mrX.use(move.ticket).at(move.destination);
//
//                    remaining = addDetectivesToRemaining();
//
//                    return new AIGameState(setup, remaining, log, mrX, detectives);
//                } else {
...
//                        remaining = ImmutableSet.<Piece>builder()
//                                .add(mrX.piece())
//                                .build();
//                    }
//                    return new AIGameState(setup, remaining, log, mrX, updatedDetectives);
//                }
//            }
//
//            @Override
//            public GameState visit(Move.DoubleMove move) {
//                LogEntry hideOrReveal1 = hideOrReveal(move.ticket1, move.destination1);
//                //Add first move to the log
//                log = updateLog(hideOrReveal1);
//
//                //Add second move to the log
//                LogEntry hideOrReveal2 = hideOrReveal(move.ticket2, move.destination2);
//                log = updateLog(hideOrReveal2);
//
//                mrX = mrX.use(move.ticket1).use(move.ticket2)
...
//    }
//
//    private ImmutableSet<Move> initMoves() {
...
//            detectives.stream()
//                    .filter(s -> this.remaining.contains(s.piece()))
